...
class ProtBertPPIModel(pl.LightningModule):
    ...
    def __init__(self, params) -> None:
        ...
        # }
        # self.save_hyperparameters(clean_params) 
    ...
    def __build_model(self) -> None:
        ...
        config = BertConfig.from_pretrained('/mnt/Data6/hjy/STEP/pretrained_models/prot_bert_bfd/')
        config.gradient_checkpointing = True
        self.ProtBertBFD = BertModel.from_pretrained('/mnt/Data6/hjy/STEP/pretrained_models/prot_bert_bfd/', config=config)
        self.encoder_features = 1024

        # Tokenizer
        self.tokenizer = BertTokenizer.from_pretrained('/mnt/Data6/hjy/STEP/pretrained_models/prot_bert_bfd/', do_lower_case=False)
