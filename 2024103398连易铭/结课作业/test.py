...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='/home/a12/lym/RefCOD/datasets/R2C7K/', help='the path to put dataset')
    #自己改的
    parser.add_argument('--save_root', type=str, default='./trained model/', help='the path to save model params and log')
    # 自己改的
    ...
    #自己改的
    params_path = os.path.join(opt.save_root, 'saved_models/',
                               '{}.pth'.format(opt.model_name))  # './snapshot/saved_models/r2cnet.pth'
    print(params_path)
    #自己改的
