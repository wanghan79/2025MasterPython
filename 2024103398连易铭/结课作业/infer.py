...
if __name__ == '__main__':
    ...
    #自己改的
    params_path = os.path.join(opt.save_root, 'saved_models', opt.model_name, 'Net_epoch_30.pth')
    #params_path = os.path.join('/home/a12/lym/RefCOD/trained model/saved_models/r2cnet.pth')
    #自己改的结束
    #原版
