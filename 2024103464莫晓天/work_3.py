...
if __name__ == "__main__":
    ...
    # 生成并打印产品数据
    print("生成的产品信息:")
    product_data = sampler.generate(**product_info)
    print(product_data)

    # 生成并分析订单数据
    order_data = sampler.generate(
        order_id={"type": "int", "datarange": (1000, 9999)},
        customer={
            "type": "dict",
            "subs": {
                "name": {"type": "str", "datarange": string.ascii_letters, "len": 8},
                "premium": {"type": "bool"}
            }
        },
        items={
            ...
            "elements": {
                ...
                "subs": {
                    ...
                    "quantity": {"type": "int", "datarange": (1, 5)},
                    "price": {"type": "float", "datarange": (10.0, 100.0)}
                }
            }
        }
    )
    ...
    # 分析数据并显示统计结果
    result, stats = sampler.analyze(order_data)
    print("\n订单数据统计:")
    print(stats)